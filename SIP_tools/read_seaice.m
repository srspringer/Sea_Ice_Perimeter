function [S]=read_seaice(hemi,SDtime,seaice_key)

if(seaice_key=='SSMI1')
    S=read_ssmi_nt1_bin(hemi,SDtime,25,ssmi_nt1_data_path);
elseif(seaice_key=='SSMI2')
    data_path='/net/esrdata1/springer/data/SeaIce/SSMI_NT2/South/';
...
elseif(seaice_key=='AMSRH'); % AMSRE in HDF format
    data_path='/net/esrdata1/springer/data/AMSRE/n5eil01u.ecs.nsidc.org/AMSA/AE_SI12.003/';
    S=read_amsre_hdf(hemi,SDtime,data_path);
elseif(seaice_key=='AMSR2'); 
    data_path='/net/esrdata1/springer/data/AMSR2/ftp-projects.cen.uni-hamburg.de/seaice/AMSR2/3.125km/';
    S=read_amsr2_cdf(hemi,SDtime,data_path);
elseif(seaice_key=='AMSEB'); 
    data_path='/net/esrdata1/springer/data/AMSRE-ASI/ftp-projects.cen.uni-hamburg.de/seaice/AMSR-E_ASI_IceConc/hdf/s6250/';
